...
import 'rxjs';
import { extend as _extend, omit as _omit, find as _find, map as _map, forEach as _forEach, reduce as _reduce, merge as _merge } from 'lodash';
...
export class QuarterbacksComponent implements OnInit {
  public players: any;
  public stats: any;
  // public mergedStats: any;
  // public data: any;
  // public compiledStats: any;
...
calculatePasserRating(completions: number, attempts: number, yards: number, tds: number, interceptions: number) {
  let rating = 0;
